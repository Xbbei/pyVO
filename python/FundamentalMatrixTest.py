...
sevenpointestimator = pyVO.fundamental_matrix.FundamentalMatrixSevenPointEstimator()
...
eightpointestimator = pyVO.fundamental_matrix.FundamentalMatrixEightPointEstimator()
